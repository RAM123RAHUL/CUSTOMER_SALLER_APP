...
class Allorders extends StatefulWidget {
  ...
  @override
  State<Allorders> createState() => _OrdermanagementState();
}

class _OrdermanagementState extends State<Allorders> {
                      ...
                      child: InkWell(
                        onTap: () {
                          ...
                          Navigator.push(
                              ...
                              MaterialPageRoute(builder: (context) => Allpackage()) // Replace with the appropriate page
                          );
                        },
                        child: Container(
