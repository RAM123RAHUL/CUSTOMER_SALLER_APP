        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text('Stocks Management',style: TextStyle( fontSize: 18,fontStyle: FontStyle.italic), ),
              Padding(
                  ...
                  children: [
                    Expanded(
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            Text('Live Stocks', style: TextStyle(fontSize: 18)),
                            SizedBox(height: 10),
                    ...
                    child: Card(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            buildOrderRow('Stock No.', 'ZX-563JD'),
