...
import 'package:pikaaya_customer_seller/Saller/AllOrders.dart';
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            Text('Live Orders', style: TextStyle(fontSize: 18)),
                            SizedBox(height: 10),
                            Text('03',
                                style: TextStyle(
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            Text('All Orders', style: TextStyle(fontSize: 18)),
                            SizedBox(height: 10),
                            Text('37',
                                style: TextStyle(
                                    fontSize: 24, fontWeight: FontWeight.bold)),
